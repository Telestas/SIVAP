...
class Demo {
  ...
  static const pacientes = <DemoPaciente>[
      ...
      eventos: [
        ...
        DemoEvento(
          ...
          6,
          {
            ...
            'estancia_uci': 'De 6 a 14 días',
            // Egresó vivo hace más de una semana y nadie ha hecho el contacto
            // del día 7: es la alerta de seguimiento, vista desde la app.
            'estado_egreso': 'Vivo',
            'fecha_egreso_uci': '2026-08-12',
          },
          recolectorId: 'u-003',
        ),
      ],
    ...
    // Extubado ayer y sin desenlaces: el evaluador tiene trabajo esperando.
    DemoPaciente(
      id: 'p-demo-08',
      correlativo: 5,
      nombre: 'Dulce María Aguilar Ponce',
      hc: 'DEMO-08',
      telefono: '5 000 0008',
      edad: 57,
      sexo: Sexo.femenino,
      ...
      protocolo: Protocolo.a,
      recolectorId: 'u-001',
      diasDesdeEnrolamiento: 5,
      sync: SyncStatus.enCola,
      eventos: [
        DemoEvento(TipoEvento.enrolamiento, 0, {
          'fecha_ingreso_uci': '2026-08-13',
          'fecha_inicio_vmi': '2026-08-15',
          'causa_intubacion': 'Neurológica',
          'via_aerea_dificil': false,
          'tot_menor_igual_65': false,
          'peso': 66,
        ...
        DemoEvento(TipoEvento.cribado, 2, {'cumple_criterios': true}),
        DemoEvento(TipoEvento.pruebaVentilacionEspontanea, 3, {
          'modo_ventilatorio_previo': 'PS',
          'metodo_pve': 'PSV',
          'duracion_pve': 'De 30 a 59 min',
          'resultado_pve': 'Éxito',
